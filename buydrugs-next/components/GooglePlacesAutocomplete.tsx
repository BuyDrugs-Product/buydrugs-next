...
export const GooglePlacesAutocomplete: React.FC<GooglePlacesAutocompleteProps> = ({
    ...
    useEffect(() => {
        ...
        const handleScriptLoad = () => {
            ...
            // Validate that Places library is actually available
            if (!window.google?.maps?.places) {
                setScriptError('Google Maps Places library failed to load. Please ensure the API key has Places API enabled.');
        ...
        // Only match scripts that include the Places library
        const existingScript = document.querySelector('script[src*="maps.googleapis.com"][src*="libraries=places"]') as HTMLScriptElement | null;
        if (existingScript) {
