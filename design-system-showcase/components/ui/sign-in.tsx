            ...
            <div className="relative flex w-full flex-col justify-between rounded-[26px] bg-linear-to-b from-violet-700/80 via-violet-800/85 to-violet-950/95 p-8 text-white">
              ...
              <div className="relative space-y-4">
                <p className="text-[11px] uppercase tracking-[0.4em] text-white/60">
                  {narrativeSlides[currentSlide].badge}
                </p>
                <h2 className="text-3xl font-semibold leading-snug">
                  {narrativeSlides[currentSlide].heading}
                </h2>
                <p className="text-white/85">{narrativeSlides[currentSlide].body}</p>
                {narrativeSlides[currentSlide].statValue && (
                  <div className="mt-5 inline-flex items-baseline gap-4 rounded-2xl border border-white/20 bg-white/10 px-6 py-4">
                    <span className="text-4xl font-semibold">{narrativeSlides[currentSlide].statValue}</span>
                    <span className="text-sm text-white/85">{narrativeSlides[currentSlide].statLabel}</span>
                  </div>
                )}
                {narrativeSlides[currentSlide].quoteText && (
                  <div className="mt-5 space-y-2 rounded-2xl border border-white/15 bg-white/10 p-5">
                    <p className="text-sm italic text-white/90">“{narrativeSlides[currentSlide].quoteText}”</p>
                    <p className="text-xs uppercase tracking-[0.3em] text-white/70">
                      {narrativeSlides[currentSlide].quoteAttribution}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="relative mt-6 flex items-center justify-between">
                ...
                <span className="text-xs text-white/70">
                  {currentSlide + 1}/{narrativeSlides.length}
                </span>
              </div>
            </div>
          </section>
